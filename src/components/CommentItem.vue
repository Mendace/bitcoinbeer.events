<template>
    <div class="p-4 bg-gray-800 rounded mb-2" :class="{ 'opacity-50': comment.status === 'pending' }">
      ...
      <div class="flex flex-wrap items-center space-x-3 mt-3">
        <!-- Se loggedIn => pulsanti attivi, altrimenti disabilitati -->
        ...
        <!-- Se NON loggato => mostra contatori, ma non pulsanti cliccabili -->
        <template v-else>
  ...
  export default {
    ...
    props: {
      ...
      loggedIn: { type: Boolean, default: false } // Per mostrare/nascondere i pulsanti
    },
    setup(props) {
      ...
      async function sendReply() {
        ...
        try {
          const bodyObj = {
            ...
            author: replyAuthor.value || 'Anonimo',
            content: replyContent.value
          };
          // Se siamo loggati => passiamo token (per user_id)
